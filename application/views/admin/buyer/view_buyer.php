      ...
      <div class="row">
		...
		<div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs">
              ...
              <li class="active"><a href="#buyer_info" data-toggle="tab">Buyer Info</a></li>

			  <a href="<?php echo base_url(); ?>admin/buyer"  class="btn btn-primary add-photo"  style="color:#ffffff; float:right;margin: 4px 7px 0px 0px;"><i class="fa fa-backward">&nbsp;</i>Back</a>
              ...
              <div class="active tab-pane" id="restaurant_info">
				...
				<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
										 ...
										 <tr>
									     <th>First Name</th>
										 <td><?php echo ucfirst($buyer->first_name); ?></td>
										 </tr>
										
										<tr>
									     <th>Last Name</th>
										 <td><?php echo ucfirst($buyer->last_name); ?></td>
										 </tr>
										 
										 <tr>
									     <th>Email</th>
										 <td><?php echo ucfirst($buyer->email); ?></td>
										 </tr> 
										 ...
										 <tr>
									     <th>Address</th>
										 <td><?php echo ucfirst($buyer->address); ?></td>
										 </tr>
										 ...
										 <tr>
									     <th>Profile Image</th>
										 <td> <?php if($buyer->profile_image !='' && file_exists('public/image_gallery/buyer/small_thumb/'.$buyer->profile_image)){?>
			...
			<?php } ?></td>
										  ...
										  <tr>
									     <th>Status</th>
										 <td><?php if($buyer->status=='1'){echo "Active";}else{echo "Inactive";}; ?></td>
										 </tr>
