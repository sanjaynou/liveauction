  ...
  <div class="content-wrapper">
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <form role="form" method="post" action="<?php echo base_url(); ?>admin/buyer/add" enctype="multipart/form-data">
              <div class="box-body">
    ...
    <input type="password" name="password" id="password" class="form-control" placeholder="" required  value="<?php echo $this->input->post('password');?>">
				 ...
				 <div class="form-group">
                  ...
                  <input type="text" name="address" id="address" class="form-control " placeholder="" value=""  required>
    ...
    <input type="text" name="phone" id="phone" class="form-control" placeholder="" required  value="<?php echo $this->input->post('phone');?>">
      </div>
