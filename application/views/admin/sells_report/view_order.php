...
<head>
  ...
  <title><?php echo $title; ?> | Admin | View Sales Report</title>
      ...
      <div class="row">
		...
		<div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs">
              ...
              <li class="active"><a href="#Order_detail" data-toggle="tab">Sales Order Detail</a></li>

			  <a href="<?php echo base_url(); ?>admin/sells_report"  class="btn btn-primary add-photo"  style="color:#ffffff; float:right;margin: 4px 7px 0px 0px;"><i class="fa fa-backward">&nbsp;</i>Back</a>
