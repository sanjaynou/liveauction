...
<head>
  ...
  <title><?php echo $title; ?> | Admin | Product Per Page</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Product Per Page </h3>
			 
            </div>
            <!-- /.box-header -->
			<?php if($this->session->flashdata('success')){?><div class="success"><?php echo $this->session->flashdata('success');?></div><?php } ?>
				
            <form role="form" method="post" action="<?php echo base_url();?>admin/cms/product_page" enctype="multipart/form-data">
              <div class="box-body">
			 
			  <div class="form-group">
                  <label for="exampleInputEmail1">Product Per Page</label>
                  <input type="text" name="product_per_page" id="product_per_page" class="form-control " placeholder="" value="<?php echo $productcount->product_per_page; ?>" required >
                </div>
