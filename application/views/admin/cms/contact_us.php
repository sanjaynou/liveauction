...
<head>
  ...
  <title><?php echo $title; ?> | Admin | Contact Us</title>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <form role="form" method="post" action="<?php echo base_url();?>admin/cms/contact_us" enctype="multipart/form-data">
              <div class="box-body">
			 
			  <div class="form-group">
                  <label for="exampleInputEmail1">Address</label>
                  <input type="text" name="address" id="address" class="form-control " placeholder="" value="<?php echo $contactDetail->address; ?>" required >
                </div>
				
								<div class="form-group">
                  <label for="exampleInputEmail1">Email </label>
                  <input type="email" name="email" id="email" class="form-control " placeholder="" value="<?php echo $contactDetail->email; ?>" required >
                </div>
				
				<div class="form-group">
                  <label for="exampleInputEmail1">Phone number</label>
                  <input type="text" name="phone_number" id="phone_number" class="form-control " placeholder="" value="<?php echo $contactDetail->phone_number; ?>" required >
                </div>
