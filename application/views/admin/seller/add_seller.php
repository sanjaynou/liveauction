...
<div class="wrapper">
  ...
  <div class="content-wrapper">
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <form role="form" method="post" action="<?php echo base_url(); ?>admin/seller/add" enctype="multipart/form-data">
              <div class="box-body">
			 
		 
	  <div class="form-group">
                  <label for="exampleInputEmail1">First Name </label>
    <input type="text" name="first_name" id="first_name" class="form-control txtboxToFilter" placeholder="" required  value="<?php echo $this->input->post('first_name');?>">
      </div>
	  <div class="form-group">
                  <label for="exampleInputEmail1">Last Name </label>
    <input type="text" name="last_name" id="last_name" class="form-control txtboxToFilter" placeholder="" required  value="<?php echo $this->input->post('last_name');?>" >
      </div>
	  <div class="form-group">
                  <label for="exampleInputEmail1">Email </label>
    <input type="email" name="email" id="email" class="form-control" placeholder="" required  value="<?php echo $this->input->post('email');?>">
      </div>
	 <div class="form-group">
    ...
    <input type="text" name="shipment_fee_domestic" id="shipment_fee_domestic" class="form-control txtboxToFilter" placeholder="" required  value="<?php echo $this->input->post('shipment_fee_domestic');?>">
	</div>
      </div>
	   <div class="form-group">
				  ...
				  <div class="input-group">
                <span class="input-group-addon"><?php echo $country_price->price_symbol;?></span>
    <input type="text" name="shipment_fee_international" id="shipment_fee_international" class="form-control txtboxToFilter" placeholder="" required  value="<?php echo $this->input->post('shipment_fee_international');?>">
	</div>
      </div>
	  <div class="form-group">
                  <label for="exampleInputEmail1">Password </label>
    <input type="password" name="password" id="password" class="form-control" placeholder="" required  value="<?php echo $this->input->post('password');?>">
      </div>
				 ...
				 <div class="form-group">
                  ...
                  <input type="text" name="address" id="address" class="form-control " placeholder="" value="<?php echo $this->input->post('address');?>"  required>
				...
				<div class="form-group">
                  ...
                  <input type="text" name="postcode" id="postcode" class="form-control " placeholder="" value="<?php echo $this->input->post('postcode');?>"  required>

                </div>
				
	   <div class="form-group">
                  <label for="exampleInputEmail1">Phone</label>
    <input type="text" name="phone"  data-inputmask='"mask": "999-999-9999"' data-mask id="phone" class="form-control" placeholder="" required  value="<?php echo $this->input->post('phone');?>">
      </div>
