...
<head>
  ...
  <title><?php echo $title; ?> | Admin | Transaction Report</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Manage Transaction Report</h3>
			  
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive">
			<form method="post" action="<?php echo base_url();?>admin/transaction_report">
