...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Edit Auction Product </h3>
            ...
            <form role="form" method="post" action="<?php echo base_url();?>admin/auctionproduct/edit/id/<?php echo $auctionproduct->product_id;?>" enctype="multipart/form-data">
			<input type="hidden" id="category_id_hidden" class="category_id_hidden" name="category_id_hidden" value="<?php echo $auctionproduct->category_id;?>">
              <div class="box-body">
			 <div class="col-md-6">
		 
	  <div class="form-group">
                  <label for="exampleInputEmail1">Product Name </label>
    <input type="text" name="product_name" id="product_name" class="form-control txtboxToFilter" placeholder="" required  value="<?php echo $auctionproduct->product_name; ?>">
      </div>
	  ...
	  <div class="form-group">
				 ...
				 <a href="#" data-target="#postModal" data-toggle="modal"><input id="category_data" class="form-control category_data" type="phone" placeholder="" name="category_id" data-bv-field="" style="background: url(<?php echo base_url();?>public/img/arrow.jpg) center right no-repeat; " value="<?php echo $auctionproduct->category_path;?>"></a>
    ...
    <input type="text" name="auction_timer" id="auction_timer" class="form-control txtboxToFilter" placeholder="" required  value="<?php echo $auctionproduct->auction_timer; ?>">
      </div>
    ...
    <input type="text" name="min_bid" id="min_bid" class="form-control txtboxToFilter" placeholder="" required  value="<?php echo $auctionproduct->min_bid; ?>">
      </div>
   ...
   <div class="form-group">
				...
				<img class="imageThumb" src="<?php echo base_url(); ?>public/image_gallery/auctionproduct/<?php echo $image_data['product_images']; ?>" title="<?php echo $image_data['product_images']; ?>"><br>
    ...
    <select class="form-control" name="seller_id" required >
			 ...
			 {?>
											<option value="<?php echo $allseller->seller_id;?>" <?php if($allseller->seller_id==$auctionproduct->seller_id){?>selected="selected"<?php } ?>><?php echo ucfirst($allseller->first_name).'&nbsp;'.ucfirst($allseller->last_name); ?></option>
											<?php } ?>
				   </select>
      </div>
	  <div class="form-group">
                  <label for="exampleInputEmail1">SKU </label>
    <input type="text" name="sales_sku" id="sales_sku" class="form-control" placeholder="" required  value="<?php echo $auctionproduct->sales_sku;?>">
      </div>
	  <div class="form-group">
                  <label for="exampleInputEmail1">Time Increase/Bid </label>
    <input type="text" name="time_increase_perbid" id="time_increase_perbid" class="form-control txtboxToFilter" placeholder="" required  value="<?php echo $auctionproduct->time_increase_perbid; ?>">
      </div>
	  <div class="form-group">
                  <label for="exampleInputEmail1">Bid Interval</label>
    <input type="text" name="bid_interval" id="bid_interval" class="form-control txtboxToFilter" placeholder="" required  value="<?php echo $auctionproduct->bid_interval; ?>">
      </div>
	  <div class="form-group">
				 ...
				 <textarea name="product_desc" id="product_desc" class="form-control ckeditor" ><?php echo $auctionproduct->product_desc; ?></textarea>
