      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <form role="form" method="post" action="<?php echo base_url(); ?>admin/country/add" enctype="multipart/form-data">
              <div class="box-body">
			 
			  
			  <div class="form-group">
                  <label for="exampleInputEmail1">Country Name</label>
       <input type="text" name="country_name" id="country_name" class="form-control " placeholder="" required>
                </div>
			
			<div class="form-group">
                  <label for="exampleInputEmail1">Price Symbol</label>
                  <input type="text" name="price_symbol" id="price_symbol" class="form-control " value="" placeholder="" required>
                </div>
