        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
			  ...
			  <a href="<?php echo base_url(); ?>admin/country"  class="btn btn-primary add-photo"  style="color:#ffffff; float:right;"><i class="fa fa-backward">&nbsp;</i>Back</a>
            </div>
            <!-- /.box-header -->
      <form role="form" method="post" action="<?php echo base_url('admin/country/edit/id/'.$country->country_id); ?>" enctype="multipart/form-data">
              <div class="box-body">
			 
			  
			  <div class="form-group">
                  <label for="exampleInputEmail1">Country Name</label>
                  <input type="text" name="country_name" id="country_name" class="form-control " value="<?php echo $country->country_name;?>" placeholder="" required>
                </div>
				
				<div class="form-group">
                  <label for="exampleInputEmail1">Price Symbol</label>
                  <input type="text" name="price_symbol" id="price_symbol" class="form-control " value="<?php echo $country->price_symbol;?>" placeholder="" required>
                </div>
