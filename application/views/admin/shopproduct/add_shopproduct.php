...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <input type="text" name="product_name" id="product_name" class="form-control" placeholder="" required  value="<?php echo $this->input->post('product_name');?>">
      </div>
      <div class="form-group">
    ...
    <input type="text" name="sales_price" id="sales_price" class="form-control txtboxToFilter" placeholder="" required  value="<?php echo $this->input->post('sales_price');?>">
	</div>
      </div>
     
      <div class="form-group">
                  <label for="exampleInputEmail1">Product Quantity </label>
    <input type="text" name="prodcut_quantity" id="prodcut_quantity" class="form-control txtboxToFilter" placeholder="" required  value="<?php echo $this->input->post('prodcut_quantity');?>">
      </div>
      <div class="form-group">
    ...
    <input type="text" name="sales_sku" id="sales_sku" class="form-control" placeholder="" required  value="<?php echo $this->input->post('sales_sku');?>">
      ...
      <div class="form-group">
				  ...
				  <div class="input-group">
                <span class="input-group-addon"><?php echo $country_price->price_symbol;?></span>
    <input type="text" name="discount_price" id="discount_price" class="form-control txtboxToFilter" placeholder="" required  value="<?php echo $this->input->post('discount_price');?>">
	</div>
      </div>
