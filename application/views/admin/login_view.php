...
<head>
  ...
  <title><?php echo $title; ?> | Admin | Log in</title>
  ...
  <div class="login-box-body">
	...
	<div id="myDiv"><?php if(isset($error) && $error!=''){?><br /><div class="error" style="margin:10px 0px;"><div id="close" style="float:right; cursor:pointer;">X</div><?=$error?></div><?php } ?></div>
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Username" autocomplete="off" name="username" value="<?php echo $this->input->cookie('username_cookie',TRUE);?>">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" autocomplete="off" placeholder="Password" name="password" value="<?php echo $this->input->cookie('pass_cookie',TRUE);?>">
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox" name="remember" value="1" <?php if($this->input->cookie('username_cookie')){?>checked="checked"<?php } ?>> Remember Me
            </label>
          </div>
        </div>
        <!-- /.col -->
