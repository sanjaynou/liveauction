...
<head>
  ...
  <title><?php echo $title; ?> | Admin | Shop Category</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Edit  Shop Category </h3>
			  <a href="<?php echo base_url(); ?>admin/category/shop"  class="btn btn-primary add-photo"  style="color:#ffffff; float:right;"><i class="fa fa-backward">&nbsp;</i>Back</a>
            </div>
            <!-- /.box-header -->
      <form role="form" method="post" action="<?php echo base_url('admin/category/edit_shopcategory/id/'.$category->category_id); ?>" enctype="multipart/form-data">
              <div class="box-body">
			 
			  
			  <div class="form-group">
                  <label for="exampleInputEmail1">Category Name</label>
                  <input type="text" name="category_name" id="category_name" class="form-control " value="<?php echo $category->category_name;?>" placeholder="" required>
                </div>
