        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Auction  Shop Category </h3>
			  <a href="<?php echo base_url(); ?>admin/category/auction"  class="btn btn-primary add-photo"  style="color:#ffffff; float:right;"><i class="fa fa-backward">&nbsp;</i>Back</a>
            </div>
            <!-- /.box-header -->
      <form role="form" method="post" action="<?php echo base_url('admin/category/edit_auctioncategory/id/'.$category->category_id); ?>" enctype="multipart/form-data">
              <div class="box-body">
