        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
			  ...
			  <a href="<?php echo base_url(); ?>admin/category"  class="btn btn-primary add-photo"  style="color:#ffffff; float:right;"><i class="fa fa-backward">&nbsp;</i>Back</a>
            </div>
            <!-- /.box-header -->
      <form role="form" method="post" action="<?php echo base_url('admin/category/edit/id/'.$category->category_id); ?>" enctype="multipart/form-data">
              <div class="box-body">
