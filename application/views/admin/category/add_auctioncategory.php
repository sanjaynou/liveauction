        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Add Auction Category </h3>
            ...
            <!-- /.box-header -->
            <form role="form" method="post" action="<?php echo base_url(); ?>admin/category/add_auctioncategory" enctype="multipart/form-data">
              <div class="box-body">
