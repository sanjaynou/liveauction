   ...
   <?php $this->load->view('segment/buyer_sidebar');?>
       ...
       <div class="col-md-12 contant_padd">  
         <div class="order_col_main">
          <div class="order_col"> 
          <h1>Order ID:  80953000983830  <span>
          <button class="profile_btn order_col_btn" type="button">View Detail</button></span></h1>
          </div>
         ...
         <h4>Lorem Ipsum dummy text of the <br />printing</h4>
          <h5><strong>ORDER STATUS :</strong>  <span class="process">process</span></h5>
          <button class="profile_btn order_track_btn" type="submit" > TRACK ORDER </button>
         </div>
         <div class="col-md-3 " ><h3 style="padding-top:20px; text-align:center">Order Amount<br /><font>$ 2.99</font></h3></div>
         </div>
         
         <div class="bdr"></div>
         <p class="order_col_bottom_text">Order Time & Date:<span style="color:#000"> 17:22 Feb. 23 2018</span></p>
         </div>
         ...
         <h1>Dapibus tellus eget </h1>
         <h4>Lorem Ipsum dummy text of the <br />printing</h4>
          <h5><strong>ORDER STATUS :</strong>  <span>Delivered</span></h5>
         </div>
         <div class="col-md-3 " ><h3 style="padding-top:20px; text-align:center">Order Amount<br /><font>$ 2.99</font></h3></div>
         </div>
         <div class="bdr"></div>
